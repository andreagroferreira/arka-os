...
description: >
  ...
  "planeia o pentest", "/dev red-team". SKIP: defensive code/config audit
  (OWASP Top 10) -> dev/security-audit (defense, not offense); AI/LLM attack
  surface -> dev/ai-security; certification evidence ->
