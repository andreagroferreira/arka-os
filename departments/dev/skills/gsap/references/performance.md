...
**Related skills:** Build animations with `references/core.md` (transforms, autoAlpha) and `references/timeline.md`; for ScrollTrigger performance see `references/scrolltrigger.md`.
