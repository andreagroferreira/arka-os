...
**Related skills:** For single tweens and eases use `references/core.md`; for scroll-driven timelines use `references/scrolltrigger.md`; for React use `references/react.md`.
