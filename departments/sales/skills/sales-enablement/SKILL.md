...
description: >
  Create sales collateral reps actually use — pitch decks, one-pagers,
  objection-handling docs, ROI calculators, demo scripts, playbooks, and
  buyer persona cards, each tied back to business outcomes. TRIGGER: "sales
  deck", "pitch deck", "one-pager", "leave-behind", "objection handling",
  "deal-specific ROI analysis", "demo script", "talk track", "sales
  playbook", "proposal template", "buyer persona card", "help my sales
  team", "sales materials", "/sales sales-enablement". Colateral que os
  comerciais usam mesmo, ligado a resultados de negócio. SKIP: handling
  objections live in a sales conversation -> sales/objection-handle;
  public-facing comparison pages and battle cards -> mkt/competitor-analysis;
  marketing website copy -> landing/copy-framework; cold outreach emails ->
  mkt/cold-email; the offer being sold (bonuses, guarantees, pricing) ->
  landing/offer-create.
...
> **Agent:** Lourenço (Product Marketing Manager, marketing — matrix) | **Frameworks:** Sales deck story arc, objection response framework, buyer persona cards
...
For partner sales enablement, see the [tools registry](../../../marketing/tools/REGISTRY.md):

| Tool | What It Does | Guide |
|------|-------------|-------|
| **Introw** | Partner engagement tracking, deal registration, mutual action plans | [introw.md](../../../marketing/tools/integrations/introw.md) |

---

## Output → Obsidian

`WizardingCode/Sales/enablement/<asset>.md` — decks, one-pagers, objection
docs, demo scripts, ROI calculators, playbooks, and persona cards.

## Related ArkaOS skills

- **mkt/competitor-analysis** — public-facing comparison and alternative pages
- **landing/copy-framework** — marketing website copy
- **mkt/cold-email** — outbound prospecting emails
- **sales/revops** — lead lifecycle, scoring, routing, and pipeline management
- **saas/pricing-strategy** — pricing decisions and packaging
- **mkt/product-marketing** — foundational positioning and messaging
- **sales/proposal-write** — deal proposals built from this collateral
- **sales/objection-handle** — live objection responses that extend the objection doc
