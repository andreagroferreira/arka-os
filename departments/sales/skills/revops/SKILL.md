...
name: sales/revops
description: >
  Design the systems that connect marketing, sales, and customer success
  into one revenue engine — lead lifecycle stages, scoring, routing,
  pipeline hygiene, deal desk, and RevOps metrics. TRIGGER: "RevOps",
  "revenue operations", "lead scoring", "lead routing", "MQL", "SQL",
  "pipeline stages", "deal desk", "CRM automation", "marketing-to-sales
  handoff", "data hygiene", "leads aren't getting to sales", "pipeline
  management", "lead qualification", "when should marketing hand off to
  sales", "/sales revops". Desenha o processo antes de o automatizar. SKIP:
  cold outbound emails -> mkt/cold-email; lifecycle and nurture email flows
  -> mkt/email-sequence; pricing and packaging decisions ->
...
> **Agent:** Vicente (RevOps Lead, saas — matrix) | **Frameworks:** Lead lifecycle stages, lead scoring, speed-to-lead SLA
...
For implementation, see the [tools registry](../../../marketing/tools/REGISTRY.md). Key RevOps tools:

| Tool | What It Does | Guide |
|------|-------------|-------|
| **HubSpot** | CRM, marketing automation, lead scoring, workflows | [hubspot.md](../../../marketing/tools/integrations/hubspot.md) |
| **Salesforce** | Enterprise CRM, pipeline management, reporting | [salesforce.md](../../../marketing/tools/integrations/salesforce.md) |
| **Calendly** | Meeting scheduling, round-robin routing | [calendly.md](../../../marketing/tools/integrations/calendly.md) |
| **SavvyCal** | Scheduling with priority-based availability | [savvycal.md](../../../marketing/tools/integrations/savvycal.md) |
| **Clearbit** | Real-time lead enrichment and scoring | [clearbit.md](../../../marketing/tools/integrations/clearbit.md) |
| **Apollo** | Contact data, enrichment, and outbound sequences | [apollo.md](../../../marketing/tools/integrations/apollo.md) |
| **ActiveCampaign** | Marketing automation for SMBs, lead scoring | [activecampaign.md](../../../marketing/tools/integrations/activecampaign.md) |
| **Zapier** | Cross-tool automation and workflow glue | [zapier.md](../../../marketing/tools/integrations/zapier.md) |
| **Introw** | Partner-sourced pipeline, commissions, deal registration, QBRs | [introw.md](../../../marketing/tools/integrations/introw.md) |
| **Crossbeam** | Partner account overlaps and co-sell identification | [crossbeam.md](../../../marketing/tools/integrations/crossbeam.md) |

---

## Output → Obsidian

`WizardingCode/Sales/revops/<artifact>.md` — lifecycle stage doc, scoring
spec, routing rules, pipeline configuration, and metrics dashboard spec.

## Related ArkaOS skills

- **mkt/cold-email** — outbound prospecting emails
- **mkt/email-sequence** — lifecycle and nurture email flows
- **saas/pricing-strategy** — pricing decisions and packaging
- **mkt/analytics-report** — tracking pipeline metrics and attribution
- **saas/launch-execute** — go-to-market launch planning
- **sales/sales-enablement** — sales collateral, decks, and objection handling
- **sales/prospecting** — the list-building phase that feeds the lifecycle
