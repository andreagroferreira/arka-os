---
name: content/image-create
description: >
  Create, edit, and optimize marketing images — blog heroes, social
  graphics, product mockups, banners, brand assets, and OG images — picking
  the right AI model or design tool for the job. TRIGGER: "AI image
  generation", "generate an image", "create a graphic", "product mockup",
  "hero image", "social media graphic", "banner image", "cover photo", "OG
  image", "Flux", "Midjourney", "DALL-E", "GPT Image", "Ideogram", "Nano
  Banana", "Recraft", "Stable Diffusion", "image optimization", "compress
  images", "WebP", "/content image-create". Escolhe o modelo de IA ou a
  ferramenta de design certa para cada imagem. SKIP: paid ad image creative
  and platform ad specs -> mkt/ad-creative; video production ->
  content/video-produce; on-page conversion and image placement ->
...
# Image Create — `/content image-create`

> **Agent:** Simão (Video Producer, content production lead) | **Frameworks:** Prompt anatomy (subject-setting-style), model selection matrix, web image optimization
...
`WizardingCode/Content/image-create/<asset>.md` — image briefs, prompts,
model choices, and optimization specs (generated files saved alongside).

## Related ArkaOS skills

- **mkt/ad-creative** — paid ad image creative, platform ad specs, and scaled ad production
- **content/video-produce** — AI video production and programmatic video
- **mkt/social-strategy** — what to post and content strategy
- **landing/optimize-page** — image placement and conversion on landing pages
- **mkt/seo-audit** — image SEO (alt text, file names, lazy loading)
- **mkt/directory-submit** — Product Hunt gallery images and directory listing visuals
- **brand/mockup-generate** — device mockups and product-in-context visuals
- **brand/colors** — the brand color system to match generated assets
