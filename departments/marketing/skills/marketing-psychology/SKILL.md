---
name: mkt/marketing-psychology
description: >
  Apply psychological principles, mental models, and behavioral science to
  marketing — why people buy, how to influence behavior ethically, and how
  to make better marketing decisions. Aplica ciência comportamental ao
  marketing de forma ética e fundamentada. TRIGGER: "psychology", "mental
  models", "cognitive bias", "persuasion", "behavioral science", "why
  people buy", "decision-making", "consumer behavior", "anchoring", "social
  proof", "scarcity", "loss aversion", "framing", "nudge", "/mkt
  marketing-psychology". SKIP: applying psychology to a specific page ->
  landing/optimize-page; pricing tactics -> saas/pricing-strategy; copy
  framing -> landing/copy-framework.
...
# Marketing Psychology & Mental Models — `/mkt marketing-psychology`

> **Agent:** Luna (Marketing Director) | **Frameworks:** Cialdini Influence, Kahneman Prospect Theory, BJ Fogg Behavior Model
...
offer to run `/mkt product-marketing`. Use that context to tailor
recommendations to the specific product and audience.
...
- **`landing/optimize-page`** — apply these principles to page optimization (CRO).
- **`landing/copy-framework`** — write copy using psychological principles.
- **`saas/pricing-strategy`** — pricing psychology and tactics.
- **`mkt/ab-test`** — test psychological hypotheses with statistical rigor.
