---
name: mkt/public-relations
description: >
  Earned media for software products — getting covered by journalists,
  podcasts, and newsletters through newsjacking, proactive pitching,
  inbound press requests (HARO, Qwoted, Featured), and an owned press
  page and media kit. TRIGGER: "PR", "public relations", "press",
  "press release", "press coverage", "media outreach", "pitch a
  journalist", "get featured", "media kit", "press kit", "newsjacking",
  "HARO", "earned media", "op-ed", "guest article", "como saio na
  imprensa", "quero cobertura de imprensa", "/mkt public-relations".
  Earned media, not pull requests. SKIP: startup or SaaS or AI directory
  submissions -> mkt/directory-submit; product launch coordination ->
  saas/launch-execute; social-media engagement -> mkt/social-strategy;
  cold outreach to sales prospects -> mkt/cold-email.
...
# Public Relations & Earned Media — `/mkt public-relations`

> **Agent:** Benedita (PR & Partnerships) | **Frameworks:** PESO Model, Newsjacking, HARO Inbound
...
- **`mkt/directory-submit`** — startup, SaaS, and AI directory listings (different intent from earned media).
- **`saas/launch-execute`** — coordinate a press push with a product launch.
- **`mkt/social-strategy`** — amplify each placement across social channels.
- **`mkt/content-strategy`** — plan the op-eds and guest articles a pitch offers.
- **`mkt/cold-email`** — outreach mechanics for sales prospects (not journalist pitching).
