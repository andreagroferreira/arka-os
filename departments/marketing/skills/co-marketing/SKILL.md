---
name: mkt/co-marketing
description: >
  Find co-marketing partners and plan high-impact joint campaigns —
  audience-overlap analysis, partner scoring, campaign types (content,
  webinars, integrations, community), outreach, and lead-sharing
  structure. TRIGGER: "co-marketing", "partner marketing", "joint
  campaign", "who should we partner with", "integration marketing",
  "cross-promotion", "collaborate with another company", "partnership
  ideas", "co-brand", "com quem faço parceria", "campanha conjunta",
  "/mkt co-marketing". SKIP: customer referral or affiliate programs ->
  landing/affiliate-bridge; launch-day partnerships ->
  saas/launch-execute.
...
# Co-Marketing & Partnerships — `/mkt co-marketing`

> **Agent:** Benedita (PR & Partnerships) | **Frameworks:** Ecosystem-Led Growth, Account Mapping, Partner Scoring
...
- **`landing/affiliate-bridge`** — customer referral and affiliate programs (customers referring customers).
- **`saas/launch-execute`** — product launches with partners as a borrowed channel.
- **`mkt/content-strategy`** — content planning for co-created assets.
- **`sales/sales-enablement`** — partner-facing collateral and enablement.
