...
> **Agent:** Raquel (Lifecycle & Retention Marketer) | **Framework:** Schwartz 5 Levels + Email Marketing
...
Designs email sequences for owned audiences — welcome, nurture, launch,
cart abandonment, and win-back flows with subject lines, body copy, timing,
and segmentation. The goal is sequences that nurture relationships, drive
action, and move people toward conversion.
...
- **`saas/churn-analysis`** — cancel flows, save offers, and dunning strategy (email supports this)
- **`saas/onboarding-optimize`** — in-app onboarding (email supports this)
- **`landing/copy-framework`** — landing pages the emails link to
- **`landing/ab-test`** — testing email elements
- **`sales/revops`** — lifecycle stages that trigger email sequences
