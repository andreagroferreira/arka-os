...
description: >
  ...
  optimization -> content/platform-optimize.
...
# Social Strategy — `/mkt social <topic>`

> **Agent:** Mariana (Content Marketing Specialist) | **Framework:** STEPPS + Platform-Native Content
...
Builds the social media strategy — platform selection, content themes,
posting cadence, and engagement plan — and the content system underneath it.
The goal is content that builds audience, drives engagement, and supports
business goals.
...
- **`landing/copy-framework`** — longer-form content that feeds social
- **`landing/launch-sequence`** — coordinating social with a launch
- **`mkt/email-sequence`** — nurturing the social audience via email
- **`mkt/marketing-psychology`** — what drives engagement and sharing

## Output

Social strategy doc with content calendar, platform specs, and KPIs
