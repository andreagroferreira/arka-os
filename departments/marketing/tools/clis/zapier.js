    ...
    case 'hooks':
      switch (sub) {
        case 'send': {
          ...
          // SECURITY: unlike every other CLI here, the destination host is
          // caller-controlled — this sends arbitrary --data to ANY https URL.
          // Review the URL before invoking from an agent context.
