...
You are an expert in SaaS pricing and monetization strategy. The goal is to design pricing that captures value, drives growth, and aligns with customer willingness to pay.
...
## Pricing Research (deep dive)

Van Westendorp is covered in Step 2 above. For deeper willingness-to-pay work, add:
...
- **`saas/churn-analysis`** — cancel flows, save offers, and reducing revenue churn
- **`saas/paywall-design`** — in-app upgrade screens and trial expiration
- **`landing/offer-create`** — offer construction (bonuses, guarantees, naming) for services/courses/high-ticket B2B
- **`landing/optimize-page`** — optimizing pricing-page conversion
- **`landing/copy-framework`** — pricing-page copy
- **`landing/persuasion-apply`** — pricing psychology principles
- **`sales/proposal-write`** — proposal templates and pricing presentations
- **`fin/unit-economics`** — LTV/CAC and margin math behind the price
- **`landing/ab-test`** — testing pricing changes with statistical rigor
