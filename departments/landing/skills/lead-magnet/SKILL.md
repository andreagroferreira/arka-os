...
description: >
  Plan, create, or optimize a lead magnet for email capture and lead
  generation — gated content, content upgrades, downloadables, ebooks,
  cheat sheets, checklists, template downloads, opt-ins, freebies, PDF
  downloads, resource libraries, content offers, Notion or spreadsheet
  templates. Escolhe o formato certo por etapa do funil e desenha a
  estratégia de captura e distribuição. TRIGGER: "lead magnet", "gated
  content", "content upgrade", "freebie", "opt-in", "what should I give
  away for emails", "/landing lead-magnet". SKIP: interactive tools as
  lead magnets -> mkt/free-tools; writing the content itself ->
  landing/copy-framework; the nurture sequence after capture ->
  mkt/email-sequence; capture-form and landing-page optimization ->
...
> **Agent:** Teresa (Sales Copywriter) | **Frameworks:** Value Ladder (Brunson), Content Upgrade, Buyer's Journey stages
...
- **`mkt/free-tools`** — interactive tools as lead magnets (calculators, graders, quizzes)
- **`landing/copy-framework`** — writing the lead magnet content itself
- **`mkt/email-sequence`** — nurture sequences after lead capture
- **`landing/optimize-page`** — optimizing the capture form and landing page
- **`landing/popup-design`** — popup-based lead capture
- **`mkt/content-strategy`** — content planning and topic selection
- **`mkt/analytics-report`** — measuring lead magnet performance
- **`mkt/paid-campaign`** — paid promotion of lead magnets
- **`mkt/social-strategy`** — social media promotion

## Output → Obsidian: `WizardingCode/Landing-Pages/Lead-Magnets/LEAD-MAGNET-<slug>.md`
