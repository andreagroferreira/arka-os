---
name: community/community-marketing
description: >
  Design, launch, and grow an online community that creates value for
  members while driving retention, activation, word-of-mouth, and
  community-led growth. TRIGGER: "build a community", "community strategy",
  "Discord community", "Slack community", "community-led growth", "brand
  advocates", "user community", "forum strategy", "community engagement",
  "grow our community", "ambassador program", "community flywheel",
  "/community community-marketing". Constrói à volta de uma identidade
  partilhada, não do produto. SKIP: post-signup retention as the primary
  deliverable -> community/retention-system; event planning ->
  community/events-plan; day-to-day moderation and safety ->
  community/moderation; the community's own growth/monetization plan ->
...
> **Agent:** Beatriz (Community Strategist) | **Frameworks:** Community flywheel, shared-identity design, community health metrics
...
`WizardingCode/Community/community-marketing/<deliverable>.md` — strategy
doc, channel architecture, new-member journey, ritual calendar, ambassador
brief, or health audit report.

## Related ArkaOS skills

- **community/gamification-design** — badges, leaderboards, and ambassador incentive programs
- **community/retention-system** — retention strategies that complement community engagement
- **community/events-plan** — AMAs, rituals, and live community events
- **community/moderation** — guidelines enforcement and community safety
- **mkt/social-strategy** — content creation across social platforms
- **mkt/customer-research** — understanding your community members' needs and language
