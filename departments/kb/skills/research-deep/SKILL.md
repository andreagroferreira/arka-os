...
allowed-tools: [Read, Write, Bash, Grep, Glob, WebFetch, WebSearch, mcp__obsidian__search_notes, mcp__obsidian__write_note, mcp__graphify__query_graph]
metadata:
  origin: arkaos
---
...
# Research Deep — `/kb research-deep <question>`
