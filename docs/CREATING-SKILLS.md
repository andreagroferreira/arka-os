...
A skill is a single, named capability that an agent executes when invoked. It lives in a `SKILL.md` file, optionally alongside reference documents. ArkaOS currently has 340 core skills across 17 departments plus the `arka` orchestrator (15 meta skills), and 266 more in plugin packs.
