...
A skill is a single, named capability that an agent executes when invoked. It lives in a `SKILL.md` file, optionally alongside reference documents. ArkaOS currently has 334 core skills across 17 departments plus the `arka` orchestrator (15 meta skills), and 260 more in plugin packs.
