...
## Task 5: arka-fovory (463 lines → ≤120)

**Files:**
- Modify: `~/.claude/skills/arka-fovory/SKILL.md`
- Create: `~/.claude/skills/arka-fovory/references/workflows.md`
- Create: `~/.claude/skills/arka-fovory/references/integration.md`
...
## Task 8: arka-rothbard100 (375 lines → ≤120)
...
Command:
```bash
for skill in ~/.claude/skills/arka-{forge,comfyui,knowledge,fovory,operations,onboard,rothbard100,ecommerce,update,platform-arka}/SKILL.md; do
  echo "=== $skill ==="
  head -5 "$skill"
done
```
...
# After:
wc -l ~/.claude/skills/arka-{forge,comfyui,knowledge,fovory,operations,onboard,rothbard100,ecommerce,update,platform-arka}/SKILL.md | tail -1
```
...
- Ecosystem orchestrators we didn't touch (arka-wizardingcode, arka-rockport, arka-zugatv, arka-clubefashion, arka-cascais24horas, arka-edp, arka-lora-tester, arka-marlon) — add to follow-up if wins warrant
