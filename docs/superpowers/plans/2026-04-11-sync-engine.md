...
class TestProject:
    def test_create_with_ecosystem(self) -> None:
        p = Project(
            path="/Users/test/Herd/crm-client_retail",
            name="crm-client_retail",
        ...
        assert p.ecosystem == "client_retail"
...
class TestBuildReport:
    ...
    def test_report_with_results(self) -> None:
        ...
        skills = [SkillSyncResult(skill_name="client_commerce", status="updated", features_added=["forge"])]
...
class TestFormatReport:
    def test_format_with_changes(self) -> None:
        report = SyncReport(
            ...
            skill_results=[
                SkillSyncResult(skill_name="client_commerce", status="updated", features_added=["forge"]),
            ],
        )
