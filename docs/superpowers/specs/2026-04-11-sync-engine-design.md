...
class Project:
    ...
    ecosystem: str | None        # "fovory", "rockport", etc.
...
═══════════════════════════════════════════════════════
  ...
  Key changes:
  • Forge integration added to: fovory, rockport, cascais24horas, clubefashion
  • Spec-driven gate added to: fovory, rockport
