...
ArkaOS has 339 core skills (324 department + 15 `/arka` meta) across 17 departments, plus 265 plugin skills. You can create new ones for any department.
...
```
Validated 339 core skills across 17 departments
