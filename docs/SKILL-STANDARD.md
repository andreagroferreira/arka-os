...
ArkaOS has 341 core skills (326 department + 15 `/arka` meta) across 17 departments, plus 267 plugin skills. You can create new ones for any department.
...
```
Validated 341 core skills across 17 departments
