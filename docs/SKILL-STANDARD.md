...
ArkaOS has 340 core skills (325 department + 15 `/arka` meta) across 17 departments, plus 266 plugin skills. You can create new ones for any department.
...
```
Validated 340 core skills across 17 departments
