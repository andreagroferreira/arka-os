...
ArkaOS has 333 core skills (318 department + 15 `/arka` meta) across 17 departments, plus 259 plugin skills. You can create new ones for any department.
...
```
Validated 333 core skills across 17 departments
