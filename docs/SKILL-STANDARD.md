...
ArkaOS has 338 core skills (323 department + 15 `/arka` meta) across 17 departments, plus 264 plugin skills. You can create new ones for any department.
...
```
Validated 338 core skills across 17 departments
