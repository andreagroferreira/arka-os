...
The persona system lets you create custom AI personas from real people's content (YouTube, books, podcasts), then optionally clone them as ArkaOS agents that work alongside the built-in 89 agent files (88 unique agents).
