...
CHECK_SEVERITY: dict[str, str] = {
    ...
    # checked at WRITE time by the frontend PreToolUse gate (the
    # [arka:design] marker, excellence-mandate) — warn by default,
    # blocking when hooks.frontendGate="hard". This report row is the
