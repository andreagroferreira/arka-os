...
name: prospecting
description: >
  Find, qualify, and score prospect lists across four motions — B2B SaaS,
  general B2B, local SMB, and early-stage demand-signal discovery — turning
  an ICP into a verified, ready-to-outreach lead sheet with compliance
  guardrails. TRIGGER: "prospecting", "build a prospect list", "find
  prospects", "find leads", "lead gen list", "find SaaS companies that",
  "find B2B companies", "find local businesses", "ICP-fit accounts", "who
  should we go after", "outbound list", "target account list", "find my
  first customers", "early adopters", "design partners", "beta users", "who
  has this problem", "/sales prospecting". Constrói e qualifica a lista
  antes de qualquer outreach. SKIP: writing the outbound copy after the
  list is built -> mkt/cold-email; deep competitive research on named
  accounts -> mkt/competitor-profile; understanding why current customers
  buy -> mkt/customer-research.
metadata:
  origin: community
...
> **Agent:** Martim (SDR) | **Frameworks:** ICP qualification, demand-signal discovery, deliverability verification
...
For implementation, see the [tools registry](../../../marketing/tools/REGISTRY.md). Key prospecting tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **Apollo** | B2B / SaaS firmographic + contact discovery | - | [apollo.md](../../../marketing/tools/integrations/apollo.md) |
| **Clay** | Multi-source enrichment + waterfall | ✓ | [clay.md](../../../marketing/tools/integrations/clay.md) |
| **Clearbit** | Email-to-company enrichment | - | [clearbit.md](../../../marketing/tools/integrations/clearbit.md) |
| **ZoomInfo** | Enterprise B2B contact + intent | ✓ | [zoominfo.md](../../../marketing/tools/integrations/zoominfo.md) |
| **Hunter** | Email pattern + verification | - | [hunter.md](../../../marketing/tools/integrations/hunter.md) |
| **Snov** | Email finder + verifier | - | [snov.md](../../../marketing/tools/integrations/snov.md) |
| **Truelist** | Email deliverability validation | - | [truelist.md](../../../marketing/tools/integrations/truelist.md) |
| **Outreach** | Sales engagement (post-list) | ✓ | [outreach.md](../../../marketing/tools/integrations/outreach.md) |
| **RB2B** | Visitor identification (warm intent) | - | [rb2b.md](../../../marketing/tools/integrations/rb2b.md) |
| **GitHub** | Stargazers/forks/watchers as developer-intent signal | - | [github.md](../../../marketing/tools/integrations/github.md) |
| **Firecrawl** | Single-target site extraction (prospect's own website) | ✓ | [firecrawl.md](../../../marketing/tools/integrations/firecrawl.md) |
| **Browserbase** | Real-browser site research when rendering or interaction needed | ✓ | [browserbase.md](../../../marketing/tools/integrations/browserbase.md) |

---

## Output → Obsidian

`WizardingCode/Sales/prospecting/<list-slug>.md` — the qualified lead sheet
plus search parameters, top outreach targets, and open questions.

## Related ArkaOS skills

- **mkt/cold-email** — writing outbound sequences against the qualified list (the natural next step)
- **mkt/customer-research** — why current customers buy; informs the ICP definition
- **mkt/competitor-profile** — deeper research on individual accounts (distinct from list-building qualification)
- **sales/revops** — lead routing, lifecycle, and CRM handoff after prospecting
- **sales/sales-enablement** — battle cards and one-pagers used in the outreach
- **mkt/directory-submit** — inbound discovery surfaces (prospects find you back)
- **mkt/product-marketing** — the ICP definition that anchors every prospecting engagement
