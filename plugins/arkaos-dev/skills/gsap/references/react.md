...
**Related skills:** For tweens and timelines use `references/core.md` and `references/timeline.md`; for scroll-based animation use `references/scrolltrigger.md`; for Vue/Svelte or other frameworks use `references/frameworks.md`.
