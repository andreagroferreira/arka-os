...
**Related skills:** Use with `references/core.md`, `references/timeline.md`, and `references/scrolltrigger.md` when building animations; CustomEase and other easing utilities are in `references/plugins.md`.
