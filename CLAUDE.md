...
> 89 agents. 17 departments. 341 skills. Multi-runtime. Framework-backed.
...
| Genuinely mechanical (commit messages, changelog, keyword extraction, data fetching, formatting) | Sonnet 5 at low effort / local | the ONLY tier where economy is the right call — never Haiku |
